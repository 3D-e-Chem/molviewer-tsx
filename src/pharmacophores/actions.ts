...
export const toggleContainerVisibility = (
  id: string
): IToggleContainerVisibility => ({
  type: constants.PHARMACOPHORE_TOGGLE_CONTAINER_VISIBILITY,
  id
})
...
export const togglePharmacophoreVisibility = (
  id: string
...
export const togglePharmacophoreOpacity = (
  id: string
...
export const toggleLigandVisibility = (
  id: string
...
export const hiLitefetchSucceeded = (
  payload: string[]
): IHiLitefetchSucceeded => ({
  type: constants.PHARMACOPHORES_HILITE_FETCH_SUCCEEDED,
  payload
})
...
export const togglePharmacophoreType = (
  label: string
): ITogglePharmacophoreType => ({
  type: constants.PHARMACOPHORE_TOGGLE_TYPE,
  label
})
...
export type IHiLiteAction =
  | IHiLiteShown
  | IHiLitefetchRequested
  | IHiLitefetchSucceeded

export type PharmacophoreAction =
  | IToggleAction
  | IFetchAction
  | IHiLiteAction
  | IAdjustLigandColor
